...
def get_config():
    ...
    parser.add_argument('--dropout', type=float, default=.1, metavar='D', help='input dropout')
    parser.add_argument('--layers', type=int, default=[400, 200, 100], nargs='+', help='Units in each layer')
